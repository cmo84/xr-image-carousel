...
echo [INFO] Starting the local web server with http-server on port %HTTP_SERVER_PORT%...
echo [INFO] Access your project at: http://localhost:%HTTP_SERVER_PORT%/index.html
echo [INFO] Press CTRL+C in this window to stop the server.
echo.
:: Use npx to run the locally installed http-server
call npx http-server -p %HTTP_SERVER_PORT% --cors
